...
function Feed(){
    return(
      ...
      <div className="img">
      <img src="https://www.photoglob.fr/wp-content/uploads/2017/09/photo-afrique-coucher-de-soleil-1024x682.jpeg"/>
      </div>
      <div>
        <br/>
        ...
        <div className="choice">
          <div className="cardCom">  
             <div className="btnCom" ><i class="far fa-comment"></i></div>
          </div>   
        </div>
      </div>
